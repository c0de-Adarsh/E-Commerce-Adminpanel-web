  ...
  return (
   ...
   <div className={`${toggle ? 'hidden': 'flex'} md:hidden fixed top-12 nav`}>
    <div className='bg-blue-950 w-screen h-screen bg-opacity-95 pt-24 '>
        ...
        <Link onClick={()=>setToggle(!toggle)} className='hover:text-orange-400' to='/products'>Product</Link>
        <Link onClick={()=>setToggle(!toggle)} className='hover:text-orange-400' to='/contact'>Contact</Link>
