                                    ...
                                    <div className='border pl-6 border-x-0 py-4 border-gray-400'>
                                        ...
                                        <div className='flex  gap-8 pt-2'>
                                            <div className='flex justify-center items-center'>
                                                <button className='px-3   font-bold text-xl bg-indigo-900 text-white hover:bg-indigo-700'>-</button>
                                                <input type="text" />
                                                <button className='px-3 hover:bg-indigo-700  font-bold text-xl bg-indigo-900 text-white'>+</button>
                                            </div>
                                            <button className='bg-indigo-900 text-white px-3 py-1 rounded text-lg font-medium'>Add to Cart</button>
                                        </div>
                                    </div>
